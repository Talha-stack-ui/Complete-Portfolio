    ...
    <div>
      <Navbar fixed="top" bg="light" collapseOnSelect expand="lg" >
        <Container className="d-flex  justify-content-between">
          <div>
            <Navbar.Brand href="#home"><small style={{ color: "black",fontFamily:"fantasy",fontWeight:"550", padding: "4px", borderRadius: "10px",border:"1px solid black" }}> T A </small></Navbar.Brand>
          </div>
          <div>
              ...
              <Nav className="me-auto" >
                ...
                <Nav.Link className="nav-links" href="#projects">Projects</Nav.Link>
                 {/* <LinkContainer to="/experience">
                  <Nav.Link className="nav-links">Experience</Nav.Link>
                </LinkContainer> */}
